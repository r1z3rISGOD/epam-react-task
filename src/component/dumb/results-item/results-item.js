...
var ResultsItem = function (_a) {
    var title = _a.title, genres = _a.genres, year = _a.year, picture = _a.picture, id = _a.id, active = _a.active;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetchService_1.fetchData(fetchedFilm.genres[0], 'genres', active)];
                case 2:
    ...
    return (React.createElement("div", { className: "item", onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetching()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
