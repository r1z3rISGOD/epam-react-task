...
var SearchInput = function (_a) {
    var setRequest = _a.setRequest, request = _a.request, setting = _a.setting, resultsSort = _a.resultsSort;
    var history = react_router_dom_1.useHistory();
    var dispatch = react_redux_1.useDispatch();
    return (React.createElement("form", { onSubmit: function (event) { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fetchService_1.fetchData(request, setting, resultsSort)];
                    case 1:
                        response = _a.sent();
